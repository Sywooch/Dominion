...
$(document).ready(function(){
  ...
  $('.delete_compare').live('click',function(ev){ev.preventDefault();});
  ...
  $("a.product_button.incard").click(function(ev){ev.preventDefault();});
  ...
  $("#order_button").click(function(ev){ev.preventDefault();});
  $("#order_button").click(function(ev){
    $(this).parents('form').submit();
  });

  $("a.button_link").click(function(ev){ev.preventDefault();});
  ...
  $("#forgot_form_link").click(function(ev){ev.preventDefault();});
  ...
  $('#content_cart a.product_button').click(function(ev){ev.preventDefault();});
  ...
  $('.phone_icon').click(function(ev){ev.preventDefault();});
