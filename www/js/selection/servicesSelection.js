            ...
            $.each(attributesId, function (index, value) {
                    ...
                    if (value["int_value"]["buckets"].length > 0) {
                        ...
                        var objectRange = {
                                ...
                                selectorInputMax: "input[name^=attr_range_max][xid=" + value["key"] + "]",
                                selectorInputMin: "input[name^=attr_range_min][xid=" + value["key"] + "]",
                                valueFrom: value.range_value.min_value.value,
                                valueTo: value.range_value.max_value.value
                            };
