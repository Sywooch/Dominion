...
<tr><td style="padding-left: 0px;"><table width="100%" cellpadding="0" cellspacing="0"><?
...
<tr><td class="menu" colspan="2"><ul id="section_<?=$V_CMF_SCRIPT_ID?>" style="display:<?=$sectionState?'block':'none'?>;""><?
...
?><li><a href="<?=$V_URL?>" title="<?=$V_DESCRIPTION?>"><?=$V_NAME?></a></li><dt><?=$V_DESCRIPTION?></dt><?
          }
?></ul></td></tr><?php
        }
...
<table cellpadding="0" cellspacing="0"><tr><?
        ...
        while(list($V_CMF_SCRIPT_ID,$V_NAME,$V_URL,$V_DESCRIPTION)=mysql_fetch_array($sth, MYSQL_NUM)) 
        {
          ...
          {
?><td><img src='img/<?=$pic?>' alt='<?=$V_DESCRIPTION?>' width='18' height='24' border='0'></td><td class='top_menu'><a href='index.php?e=NAV&id=<?=$V_CMF_SCRIPT_ID?>' title='<?=$V_DESCRIPTION?>'><b><?=$V_NAME?></b></a></td><?
          }
          else 
          {
?><td><img src='img/<?=$pic?>' alt='<?=$V_DESCRIPTION?>' width='18' height='24' border='0'></td><td class='top_menu'><a href='index.php?e=NAV&id=<?=$V_CMF_SCRIPT_ID?>' title='<?=$V_DESCRIPTION?>'><?=$V_NAME?></a></td><?
          }
        $pic='top_menu_left2.gif';
        }
?><td><img src='img/top_menu_right.gif' alt='' width='1' height='24' border='0'></td></tr></table></div><?
  }
