...
$_REQUEST['id']=$cmf->GetSequence('SEQUENCES');





$cmf->execute('insert into SEQUENCES (SEQUENCES_ID,NAME,ID) values (?,?,?)',$_REQUEST['id'],stripslashes($_REQUEST['NAME']),stripslashes($_REQUEST['ID'])+0);
