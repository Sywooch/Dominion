...
$cmf->execute('insert into SETINGS (SETINGS_ID,NAME,SYSTEM_NAME,VALUE) values (?,?,?,?)',$_REQUEST['id'],stripslashes($_REQUEST['NAME']),stripslashes($_REQUEST['SYSTEM_NAME']),stripslashes($_REQUEST['VALUE']));
...
$cmf->execute('update SETINGS set NAME=?,SYSTEM_NAME=?,VALUE=? where SETINGS_ID=?',stripslashes($_REQUEST['NAME']),stripslashes($_REQUEST['SYSTEM_NAME']),stripslashes($_REQUEST['VALUE']),$_REQUEST['id']);
$_REQUEST['e']='ED';
...
if($_REQUEST['e'] == 'ED')
{
list($V_SETINGS_ID,$V_NAME,$V_SYSTEM_NAME,$V_VALUE)=
$cmf->selectrow_arrayQ('select SETINGS_ID,NAME,SYSTEM_NAME,VALUE from SETINGS where SETINGS_ID=?',$_REQUEST['id']);
...
</td></tr><tr bgcolor="#FFFFFF"><td></td><td /></tr>
...
if($_REQUEST['e'] == 'Новый')
{
list($V_SETINGS_ID,$V_NAME,$V_SYSTEM_NAME,$V_VALUE)=array('','','','');
