...
$_REQUEST['id']=$cmf->GetSequence('CMF_GROUP');





$cmf->execute('insert into CMF_GROUP (CMF_GROUP_ID,NAME,URL) values (?,?,?)',$_REQUEST['id'],stripslashes($_REQUEST['NAME']),stripslashes($_REQUEST['URL']));
