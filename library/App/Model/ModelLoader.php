<?php
class App_Model_ModelLoader extends Zend_Controller_Action_Helper_Abstract {
  /**
   ...
   * @return Zend_Form
   */
  public function loadModel($name, $options = null)
  {    
      ...
      $formsDirectory  = dirname($moduleDirectory) . '/models';      

      $prefix = (('frontend' == $module) ? '' : ucfirst($module) . '_')
                . 'models_';                                
  ...
  public function direct($name, $options = null){    
      return $this->loadModel($name, $options);
  }
}
?>