...
//        $resultArray = $this->searchByElastic($search_text, $this->config->toArray());
...
//        }
        ...
        $customPaginator->setElements($this->_getParam('page'), $this->search_per_page, $elasticExecute, $search_engine['search_engine']);
