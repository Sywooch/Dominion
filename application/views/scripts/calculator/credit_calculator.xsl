	...
	<xsl:template match="credit_calculator[@bank = 'renesans']">
		...
		<div class="calculator">
			...
			<form action="/ajax/send/bank/renesans/" class="form1" id="form1">
				<div class="column">
					...
					<input type="text" name="price" id="price" size="28" maxlength="256" value="" onChange="return Pay();"/>
				</div>
				...
				<div>
					...
					<input type="button" class="button" name="application" size="28" maxlength="256" value="Подать заявку" onClick="return SendForm();"/>
				</div>
			</form>
	   ...
	   Pay();
			...
			<form action="#" class="form2" style="display:none;" id="sendForm">
				...
				<div style="clear: both;"/>
				<input type="submit" value="Отправить заявку" name="but" class="button" onClick="return SendMail(this.form)"/>
				<div style="clear: both;"/>
			</form>
		</div>
	</xsl:template>
